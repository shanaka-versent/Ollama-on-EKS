...
| qwen3.5:122b | Your AWS account (EKS) | The actual LLM brain doing the reasoning (122B MoE, 10B active) |
...
| 4 | Model Loader Job — pulls `qwen3.5:122b` to EBS volume | `k8s/model-loader/` |
...
│   └── model-loader/             # Job: pulls qwen3.5:122b
├── scripts/
